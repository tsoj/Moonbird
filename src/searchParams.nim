...
addParam(futilityReductionDiv, default = 37, min = 10, max = 500, step = 10)
...
addParam(lmrDepthHalfLife, default = 50, min = 5, max = 60, step = 10)
addParam(lmrDepthSub, default = 0.Ply, min = 0.Ply, max = 10.Ply, step = 1.Ply)
addParam(minMoveCounterLmr, default = 8, min = 1, max = 15, step = 2)

addParam(iirMinDepth, default = 3.Ply, min = 0.Ply, max = 12.Ply, step = 1.Ply)

addParam(maxHistoryTableValue, default = 127000, min = 1000, max = 10000000, step = 40000)
addParam(historyTableBadMoveDivider, default = 24.0, min = 1.0, max = 100.0, step = 8.0)
addParam(historyTableShrinkDiv, default = 1.37, min = 1.1, max = 10.0, step = 0.5)
